...
// HostsList represents a list of hosts to run a port scan.
type HostsList struct {
	Hosts []string
}

// search looks for hosts in the list.
...
// Add adds a new host to the list.
...
// Load obtains hosts form a hosts file.
