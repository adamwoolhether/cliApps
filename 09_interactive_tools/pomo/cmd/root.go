...
import (
	...
	"github.com/adamwoolhether/cliApps/09_interactive_tools/pomo/app"
...
func init() {
	...
	viper.BindPFlag("short", rootCmd.Flags().Lookup("long"))
}
...
func initConfig() {
	...
	if err := viper.ReadInConfig(); err == nil {
		...
		fmt.Println("can't use config file:", viper.ConfigFileUsed())
